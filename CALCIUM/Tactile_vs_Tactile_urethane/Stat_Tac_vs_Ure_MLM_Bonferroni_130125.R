...
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Quantif_by_Periods/AUC_persec_Znorm_Combined_tac_ure.xlsx")
...
tmp$Condition <- relevel(factor(tmp$Condition), ref = "Tac")

# Ajuster le modèle linéaire mixte avec lmerTest
model <- lmer(AUC_Znorm_persec ~ Period_type * Condition + (1 | Trial) + (1 | Animal), data = tmp)
...
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_AUC_trials_tac_vs_ure.xlsx"
...
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_AUC_trials_tac_vs_ure.xlsx"
...
# Charger les données depuis le fichier Excel
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Thresholding_Tac_vs_Ure/Above_Threshold_Combined_tac_ure.xlsx")
...
# Ajuster le modèle linéaire mixte avec lmerTest
model <- lmer(Norm_response_rate ~ Period_type * Condition + (1 | trial) + (1 | animal), data = tmp)
...
# Créer un nouveau fichier Excel
#output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_above_threshold_trials_tac_vs_ure.xlsx"
...
# Créer un nouveau fichier Excel pour sauvegarder les résultats modifiés
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_above_threshold_trials_tac_vs_ure.xlsx"
...
# Charger les données depuis le fichier Excel
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Thresholding_Tac_vs_Ure/Resp_magnitude_Combined_tac_ure.xlsx")
...
# Ajuster le modèle linéaire mixte avec lmerTest
model <- lmer(response_magnitude ~ Period_type * Condition + (1 | trial) + (1 | animal), data = tmp)
...
# Créer un nouveau fichier Excel
#output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_resp_magnitude_trials_tac_vs_ure.xlsx"
...
# Créer un nouveau fichier Excel pour sauvegarder les résultats modifiés
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Tac_vs_Tac_ure/Result_stat_R_tac_vs_ure/Stat_resp_magnitude_trials_tac_vs_ure.xlsx"
