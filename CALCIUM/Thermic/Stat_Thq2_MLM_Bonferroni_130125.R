...
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_2/Quantif_by_Periods/AUC_persec_Znorm_by_Period_wo_index_thq.xlsx")
...
model <- lmer(AUC_Znorm_persec ~ Period * Age + (1 | Trial) + (1 | Rec) + (1 | Animal), data = tmp)
...
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_2/Result_stat_R_thq2/Stat_AUC_trials_age.xlsx"
...
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_2/Result_stat_R_thq2/Stat_AUC_trials_age.xlsx"
...
# Ajuster le modèle linéaire mixte avec lmerTest
model <- lmer(AUC_Znorm_persec ~ Period * Sexe + (1 | Trial) + (1 | Rec) + (1 | Animal), data = tmp)
...
# Créer un nouveau fichier Excel
#output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_2/Result_stat_R_thq2/Stat_AUC_trials_sex.xlsx"
...
# Créer un nouveau fichier Excel pour sauvegarder les résultats modifiés
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_2/Result_stat_R_thq2/Stat_AUC_trials_sex.xlsx"
#output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
