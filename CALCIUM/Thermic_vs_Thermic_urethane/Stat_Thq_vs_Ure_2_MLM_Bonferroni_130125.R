...
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Quantif_by_Periods/AUC_persec_Znorm_Combined_thq_ure.xlsx")
...
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_AUC_trials_thq_vs_ure.xlsx"
...
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_AUC_trials_thq_vs_ure.xlsx"
...
# Charger les données depuis le fichier Excel
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Thresholding_Thq_vs_Ure/Above_Threshold_Combined_thq_ure.xlsx")
...
# Créer un nouveau fichier Excel
#output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_above_threshold_trials_thq_vs_ure.xlsx"
...
# Créer un nouveau fichier Excel pour sauvegarder les résultats modifiés
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_above_threshold_trials_thq_vs_ure.xlsx"
...
# Charger les données depuis le fichier Excel
tmp <- read_excel("G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Thresholding_Thq_vs_Ure/Resp_magnitude_Combined_thq_ure.xlsx")
...
# Créer un nouveau fichier Excel
#output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq/Result_stat/Stat_AUC_persec_Znorm.xlsx"
output_file <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_resp_magnitude_trials_thq_vs_ure.xlsx"
...
# Créer un nouveau fichier Excel pour sauvegarder les résultats modifiés
output_file_modified <- "G:/PhD/Experimentation/Calcium_imaging_WF/analysis_DFF/raw_data_Thq_vs_Thq_ure_2/Result_stat_R_thq_vs_ure/Stat_resp_magnitude_trials_thq_vs_ure.xlsx"
